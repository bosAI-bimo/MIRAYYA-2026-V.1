...
import { BrainCircuit, TrendingDown, Package, AlertCircle, TrendingUp, CheckCircle2, ChevronRight } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-5 pb-6 border-b border-slate-200 mb-6 lg:mb-8">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
          ...
          <Button className="bg-[#B76E79] hover:bg-[#9A5A66] text-white px-4 py-2.5 rounded-xl w-full sm:w-auto">
            Generate Laporan
          </Button>
        </div>
      </div>
